...
Creating and sharing a shared understanding with and among many teams next to defining a clear MVP was crucial in this project to make the deadline.
...
### Challenges
 ...
 |:-------------|:-------|
 |Little availability to gather information from users of our system|Reached out to the available contacts to create a
 group of users among all customers|
