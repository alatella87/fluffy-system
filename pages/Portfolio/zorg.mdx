...
![alt](./health_top.png "text on mouseover")
...
A few extracts of the first version of the prototype
 ...
 ### Challenges
  |Challenges|Solutions|
  |:-------------|:-------|
  |Getting the teams, including developers, involved in creating the solution|Set up a workshop with the team to create the Service Blue Print, which also included technical concepts|
