...
In order to define the requirements for the new functionality, I gathered information about our end-users form existing Persona's. Next, we held meetings with the Product Managers and Product Owners to gain insights. We also held workshops with the client to refine the requirements. 
Based on all the information and requirements acquired we created user stories. With these user stories we would create a concept and again present this to all stakeholders to validate and refine them. 
