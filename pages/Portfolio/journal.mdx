...
![alt](./journal_result1.png "text on mouseover")
...
Here you can see some of the final screens after they were adapted based on results from the usability testing:

![alt](./journal_result1.png "text on mouseover")

![alt](./journal_result2.png "text on mouseover")
Final screens
